function [dydt] = SCIB1(t , y , omega_s , theta_s , gamma , eta , Vdc_n , i_dc_r , kappa , G_dc , mu , C_dc , R , L , G , C , V_m)
u= - ( sin( ( y(1) - theta_s ) / 2 ) ); %angle feedback

dydt = [gamma * u + eta * ( y(2) - Vdc_n ); 
